...
export default function Nav() {
  ...
  return (
    <>
      <nav className="py-1 md:py-3 md:sticky top-0 z-10 flex text-sm md:text-base flex-row justify-evenly  bg-navbar text-center items-center text-text rounded-sm">
        <Link
          href={"/"}
